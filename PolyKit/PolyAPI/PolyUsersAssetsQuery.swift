...
public struct PolyUsersAssetsQuery: URLQueryResponsable {
    
    public var format: Poly3DFormat? = nil
    
    public var visibility: PolyVisibility? = nil
    ...
    public init(format: Poly3DFormat? = nil, visibility: PolyVisibility? = nil, pageSize: Int? = nil, orderBy: String? = nil, pageToken: String? = nil) {
        self.format = format
    ...
    func urlQueries() -> [URLQueryItem] {
        ...
        if let visibility = visibility {
            queries["visibility"] = visibility.rawValue
        }
